...
/****** Object:  UserDefinedFunction [dbo].[fc_P4_CAL_AN]    Script Date: 9/12/2023 7:25:46 AM ******/
DROP FUNCTION IF EXISTS [dbo].[fc_P4_CAL_AN]
GO
...
-- =============================================
CREATE FUNCTION [dbo].[fc_P4_CAL_AN]
(	
